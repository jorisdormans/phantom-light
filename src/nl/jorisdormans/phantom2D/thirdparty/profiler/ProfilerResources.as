package nl.jorisdormans.phantom2D.thirdparty.profiler
{
	import flash.text.*;
	...
	{
		// embedded resources
		[ Embed( source = "assets/fleftex.ttf", fontName = "fixedFont", embedAsCFF="false", mimeType = "application/x-font-truetype" ) ]
